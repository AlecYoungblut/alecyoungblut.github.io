            ...
            <div className="w-full">
                ...
                <div className="w-full h-screen bg-purple-300 flex justify-center items-center">
                    <div id="home" className="mx-4 text-center text-grey ">
                        ...
                        <div className="inline-flex m-12">
                        ...
                        <div className="text-left text-xl font-semibold mx-80">
                            <p>
                                Hello! My name's Alec!
                            </p>
                            <p className="pt-8">
                                I'm a recent graduate from Fanshawe College's Computer Programmer Analyst course and am a fullstack developer situated in London, Ontario. This websites purpose is to act as my portfolio for my professional development career as well as for my own personal projects and interests.
                            </p>
                            <p className="pt-4">
                        ...
                        <div className="text-lg font-semibold mx-60">
